...
namespace AE.CoreUtility
{
    ...
    FROM dbo.ToBlobs(@{blobvar})
                ...
                case IOREADPK:
                    ...
                    if (data) { // bool + binary IO per data type
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            switch (t)
                            {
                                case SQLDBT.PermissionSet: _Data[i] = IOEx.GetBuffer(io, ref ix, swap); break;
        ...
        public static bool CanIO(ref object obj, out SQLDBT dbt, Type def = null) {
            ...
            switch (obj != null ? IOEx.GetTypeCode(ref obj, out t) : def != null ? IOEx.GetTypeCode(def) : TypeCode.Empty) {
                ...
                default:
                    switch (t)
                    {
                        case IOEx.TypeCodeEx.PermissionSet: dbt = SQLDBT.PermissionSet; return true;
        ...
        private bool _Set<T>(int ix, T v) {
            ...
            switch (t)
            {
                case SQLDBT.PermissionSet: _Data[ix] = ((PermissionSet)(v as object)).ToByteArray(); return yisnull == (_Data[ix] == null);
